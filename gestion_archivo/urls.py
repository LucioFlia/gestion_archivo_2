...
from gestion_archivo_app.views import area_list, area_create, area_update, area_delete, area_import, request_close_box, approve_close_box, send_box_to_archive, box_logs, save_and_generate_security_seal, print_security_seal
...
urlpatterns = [
    ...
    path("box/<int:box_id>/print_security_seal/", print_security_seal, name="print_security_seal"),
